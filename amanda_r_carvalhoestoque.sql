...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/02/2025 às 01:30
...
--
-- Banco de dados: `amanda_r_carvalhoestoque`
--
CREATE DATABASE IF NOT EXISTS `amanda_r_carvalhoestoque` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `amanda_r_carvalhoestoque`;
...
CREATE TABLE `cliente` (
  ...
  `endereço` varchar(10) DEFAULT NULL COMMENT 'Esse campo é responsavel pelo endereço do cliente',
...
INSERT INTO `item_de_pedido` (`cod_pedido`, `cod_produto`, `quantidade`) VALUES
(121, 25, 10),
(121, 31, 35),
(97, 77, 20),
(101, 31, 9),
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `FK_CLIENTE_PEDIDO` FOREIGN KEY (`cliente_cod_cliente`) REFERENCES `cliente` (`cod_clientee`),
