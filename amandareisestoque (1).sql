...
--
-- Banco de dados: `amandareisestoque`
--
CREATE DATABASE IF NOT EXISTS `amandareisestoque` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `amandareisestoque`;
...
CREATE TABLE `cliente` (
  `cod_clientee` int(11) NOT NULL COMMENT 'esse campo é responsável por armazenara chave primaria usada para identificar tabela',
  `nome_cliente` varchar(50) NOT NULL COMMENT 'esse campo é responsável por armazenaro nome do cliente',
  `endereço` varchar(50) NOT NULL COMMENT 'esse campo é responsável por armazenar o endereçodo cliente.',
  `cidade` varchar(50) NOT NULL COMMENT 'esse campo é responsável por armazenar a cidade do cliente.',
  `cep` varchar(10) NOT NULL,
  `cnpj` varchar(30) NOT NULL,
  `uf` char(2) NOT NULL COMMENT 'esse campo é responsável por armazenaro uf do cliente (Exemplo sc)',
  `ie` int(11) NOT NULL COMMENT 'esse campo é responsável por armazenar a inscrissão estadual'
...
INSERT INTO `cliente` (`cod_clientee`, `nome_cliente`, `endereço`, `cidade`, `cep`, `cnpj`, `uf`, `ie`) VALUES
...
(720, 'Ana ', 'Rua 17 n. 19', 'Niteroi', '24358310', '12113231/0001-34', 'RJ', 2134),
...
INSERT INTO `item_do_pedido` (`cod_pedido`, `cod_produto`, `quantidade`) VALUES
(121, 25, 10),
(121, 31, 35),
(97, 77, 20),
(101, 31, 9),
...
INSERT INTO `pedido` (`cod_pedido`, `prazo_entrega`, `cod_clientee`, `cod_vendedor`) VALUES
(91, 20, 260, 11),
(97, 20, 720, 101),
(98, 20, 410, 209),
(101, 15, 720, 101),
...
INSERT INTO `produto` (`cod_produto`, `unidade_medida`, `desc_produto`, `valor_unidade`) VALUES
(13, 'G', 'Ouro', '6.18'),
(22, 'M', 'Linho', '0.11'),
(25, 'Kg', 'Queijo', '0.97'),
(30, 'SAC', 'Açucar', '0.30'),
...
--
ALTER TABLE `cliente`
  ADD PRIMARY KEY (`cod_clientee`);

--
-- Índices para tabela `item_do_pedido`
--
ALTER TABLE `item_do_pedido`
  ADD KEY `FK_cod_pedido_pedido` (`cod_pedido`),
...
ALTER TABLE `pedido`
  ...
  ADD KEY `FK_CLIENTE_PEDIDO` (`cod_clientee`),
...
--
ALTER TABLE `item_do_pedido`
  ADD CONSTRAINT `FK_cod_pedido_pedido` FOREIGN KEY (`cod_pedido`) REFERENCES `pedido` (`cod_pedido`),
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `FK_CLIENTE_PEDIDO` FOREIGN KEY (`cod_clientee`) REFERENCES `cliente` (`cod_clientee`),
