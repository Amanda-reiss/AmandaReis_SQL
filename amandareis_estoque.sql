...
--
-- Banco de dados: `amandareis_estoque`
--
CREATE DATABASE IF NOT EXISTS `amandareis_estoque` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `amandareis_estoque`;
